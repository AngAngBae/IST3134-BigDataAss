### Python Script to collectively rename and merge rap artists' csv files ###
...
spark = SparkSession.builder.appName("MergeTop5Rap").getOrCreate()

# Define the base directory where the artist folders are located
base_dir = "/user/hadoop/BDAss/rap"
