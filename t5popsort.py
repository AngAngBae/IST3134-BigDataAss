### Python Script to filter t5pop.csv into individual artist csv ###
...
spark = SparkSession.builder.appName("SortTop5Pop").getOrCreate()
...
df = spark.read.option("header", "true") \
               ...
               .option("escape", '"') \
               .csv('/user/hadoop/BDAss/t5pop.csv', encoding='utf-8')
...
for artist in artists:
    ...
    output_path = f'/user/hadoop/BDAss/pop/{artist.replace(" ", "_")}'
