### Python Script to run MapReduce on all the Top 5 rap artists' songs ###
...
input_base_path = "BDAss/rap"
output_base_path = "BDAss/rap_wc"

# List of rap artists
artists = ["Eminem", "JAY-Z", "Kendrick_Lamar", "Nas", "2Pac"]
...
print("Word count processing completed for all rap artists.")

## Merge the files
# Define the base directory where the artist folders are located
base_dir = "/user/hadoop/BDAss/rap_wc"
